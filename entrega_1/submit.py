...
def output(input_file, solver_file):
    ...
    try:
        ...
        print('the solve_it(input_data) method from solution_greedy.py raised an exception')
        print('try testing it with python ./solution_greedy.py before running this submission script')
        print('exception message:')
        print(str(e))
        print('')
