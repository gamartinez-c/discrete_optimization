...
def solve_it(input_data_list):
    ...
    if use_simple_aproache:
        for solution in solution_list:
            ...
            elif len(location_list) < 2000:
                available_time = 0.75*60*60
            else:
                available_time = 1*60*60

            solution.improve_by_2_opt(available_time)
    else:
